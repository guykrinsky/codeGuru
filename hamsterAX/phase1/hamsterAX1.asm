...
pop si ; si -> next_line
add si, start_copied_opcodes - next_line ; si -> start_copied_opcodes
...
; write the address of mapped_nums to the arena for the second survivor
add ax, mapped_nums
mov word [EXCHANGE_INFO_ADDRESS], ax
...
lea di, [si+tail] ; di points to tail TODO: check if can be there an enemy.
...
lea bx, [si + mapped_nums] ; bx -> mapped_nums 
